...
var AVideoPlayer2 = function() {
    ...
    this._initElements = function() {
      this.elProgressBar   = document.getElementById('progress-bar2');
      this.elProgressTrack = document.getElementById('progress-bar-track2');
      this.elProgressFill  = document.getElementById('progress-bar-fill2');
      this.elAlertSound    = document.getElementById('alert-sound2');
      this.elVideo         = document.getElementById('video-src2');
      this.elVideoScreen   = document.getElementById('video-screen2');
      this.elControlBack   = document.getElementById('control-back2');
      this.elControlPlay   = document.getElementById('control-play2');
      this.elControlVolume = document.getElementById('control-volume2');
    }

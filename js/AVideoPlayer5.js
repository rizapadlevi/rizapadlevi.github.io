...
var AVideoPlayer5 = function() {
    ...
    this._initElements = function() {
      this.elProgressBar   = document.getElementById('progress-bar5');
      this.elProgressTrack = document.getElementById('progress-bar-track5');
      this.elProgressFill  = document.getElementById('progress-bar-fill5');
      this.elAlertSound    = document.getElementById('alert-sound5');
      this.elVideo         = document.getElementById('video-src5');
      this.elVideoScreen   = document.getElementById('video-screen5');
      this.elControlBack   = document.getElementById('control-back5');
      this.elControlPlay   = document.getElementById('control-play5');
      this.elControlVolume = document.getElementById('control-volume5');
    }

...
var AVideoPlayerL = function() {
    ...
    this._initElements = function() {
      this.elProgressBar   = document.getElementById('progress-barL');
      this.elProgressTrack = document.getElementById('progress-bar-trackL');
      this.elProgressFill  = document.getElementById('progress-bar-fillL');
      this.elAlertSound    = document.getElementById('alert-soundL');
      this.elVideo         = document.getElementById('video-srcL');
      this.elVideoScreen   = document.getElementById('video-screenL');
      this.elControlBack   = document.getElementById('control-backL');
      this.elControlPlay   = document.getElementById('control-playL');
      this.elControlVolume = document.getElementById('control-volumeL');
    }

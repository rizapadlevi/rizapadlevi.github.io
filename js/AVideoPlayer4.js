...
var AVideoPlayer4 = function() {
    ...
    this._initElements = function() {
      this.elProgressBar   = document.getElementById('progress-bar4');
      this.elProgressTrack = document.getElementById('progress-bar-track4');
      this.elProgressFill  = document.getElementById('progress-bar-fill4');
      this.elAlertSound    = document.getElementById('alert-sound4');
      this.elVideo         = document.getElementById('video-src4');
      this.elVideoScreen   = document.getElementById('video-screen4');
      this.elControlBack   = document.getElementById('control-back4');
      this.elControlPlay   = document.getElementById('control-play4');
      this.elControlVolume = document.getElementById('control-volume4');
    }
